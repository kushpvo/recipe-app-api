...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_invalid_credentails(self):
        """Test that token is not created if invalid crednetials are given"""
...
class PrivateUserApiTests(TestCase):
    ...
    def test_retrieve_user_success(self):
        """Test retrevigin profile for logged in user"""
        res = self.client.get(ME_URL)
    ...
    def test_update_user_profile(self):
        """Test updaging the user profile for authenticated user"""
